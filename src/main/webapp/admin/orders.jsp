...
<%
    ...
    String selectedStatus = request.getAttribute("selectedStatus") == null ? "All" : String.valueOf(request.getAttribute("selectedStatus"));
%>
<!DOCTYPE html>
<html>
<head>
...
<div class="container">
    ...
    <% if (request.getParameter("deleted") != null) { %><div class="alert alert-success">Order deleted successfully.</div><% } %>

    <form class="search-bar" method="get" action="${pageContext.request.contextPath}/admin/orders">
        <select name="status">
            ...
            <% if (orders != null && !orders.isEmpty()) { %>
                <% for (Order order : orders) { %>
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-small" href="${pageContext.request.contextPath}/admin/orders?action=detail&id=<%= order.getId() %>">View / Update</a>
                            <a class="btn btn-danger btn-small" onclick="return confirm('Delete this order?')" href="${pageContext.request.contextPath}/admin/orders?action=delete&id=<%= order.getId() %>">Delete</a>
                        </td>
                    </tr>
                <% } %>
            <% } else { %>
