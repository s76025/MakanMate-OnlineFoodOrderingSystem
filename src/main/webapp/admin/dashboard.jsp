                                    ...
                                    <div class="container">
                                        ...
                                        <div class="grid">
                                            <div class="card stat-card">
                                                <h2>
                                                    <%= summary.get("totalCustomers") %>
                                                </h2>
                                                <p>Total Customers</p>
                                            </div>
                                            <div class="card stat-card">
                                                <h2>
                                                    <%= summary.get("totalMenus") %>
                                                </h2>
                                                <p>Total Menu Items</p>
                                            </div>
                                            <div class="card stat-card">
                                                <h2>
                                                    <%= summary.get("totalOrders") %>
                                                </h2>
                                                <p>Total Orders</p>
                                            </div>
                                            <div class="card stat-card">
                                                <h2>RM <%= String.format("%.2f", (Double) summary.get("totalRevenue"))
                                                        %>
                                                </h2>
                                                <p>Total Revenue</p>
                                            </div>
                                        ...
                                        <div class="table-wrap">
                                            <table>
                                                ...
                                                <% if (recentOrders !=null && !recentOrders.isEmpty()) { %>
                                                    <% int count=0; for (Order order : recentOrders) { if (count++>= 5)
                                                        break; %>
                                                        <tr>
                                                            ...
                                                            <td><a class="btn btn-small"
                                                                    href="${pageContext.request.contextPath}/admin/orders?action=detail&id=<%= order.getId() %>">View</a>
                                                            </td>
                                                        </tr>
                                                        <% } %>
                                                            <% } else { %>
