            ...
            <% if (orders != null && !orders.isEmpty()) { %>
                <% for (Order order : orders) { %>
                    <tr>
                        ...
                        <td>
                            <span class="badge <%= "Completed".equals(order.getStatus()) ? "badge-green" : ("Cancelled".equals(order.getStatus()) ? "badge-red" : "badge-yellow") %>"><%= order.getStatus() %></span>
                        </td>
                        <td><a class="btn btn-small" href="${pageContext.request.contextPath}/orders?action=detail&id=<%= order.getId() %>">View Details</a></td>
                    </tr>
                <% } %>
            <% } else { %>
