    ...
    <%@ page import="java.util.List" %>
        <%@ page import="com.makanmate.model.MenuItem" %>
            <%@ page import="com.makanmate.model.User" %>
                <% User currentUser=(User) session.getAttribute("user"); List<MenuItem> items = (List
                    <MenuItem>) request.getAttribute("items");
                    String selectedCategory = request.getAttribute("category") == null ? "All" :
                    String.valueOf(request.getAttribute("category"));
                    String keyword = request.getAttribute("keyword") == null ? "" :
                    String.valueOf(request.getAttribute("keyword"));
                    %>
                    <!DOCTYPE html>
                    <html>
                    ...
                    <body>
                        <div class="navbar">
                            <div class="nav-inner">
                                ...
                                <div class="nav-links">
                                    <a class="active" href="${pageContext.request.contextPath}/menu">
                                        Menu
                                    </a>
                        ...
                        <div class="container">
                            <div class="page-title">
                                <div>
                                    <h1>Food Menu</h1>
                                    <p class="muted">Hi <%= currentUser.getName() %>, choose your food and add it to
                                            cart.</p>
                                </div>
                            ...
                            <form class="search-bar" method="get" action="${pageContext.request.contextPath}/menu">
                                ...
                                <select name="category">
                                    <option value="All" <%="All" .equals(selectedCategory) ? "selected" : "" %>>All
                                    </option>
                                    <option value="Rice" <%="Rice" .equals(selectedCategory) ? "selected" : "" %>>Rice
                                    </option>
                                    <option value="Noodles" <%="Noodles" .equals(selectedCategory) ? "selected" : "" %>
                                        >Noodles</option>
                                    <option value="Western" <%="Western" .equals(selectedCategory) ? "selected" : "" %>
                                        >Western</option>
                                    <option value="Drinks" <%="Drinks" .equals(selectedCategory) ? "selected" : "" %>
                                        >Drinks</option>
                                </select>
                                    ...
                                    <% for (MenuItem item : items) { %>
                                        <div class="card menu-card">
                                            ...
                                            <div class="menu-card-content">
                                                ...
                                                <p class="price">RM <%= String.format("%.2f", item.getPrice()) %>
                                                </p>
